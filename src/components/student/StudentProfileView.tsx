              ...
              userOrgs.map((org) => (
                <div key={org.id} className="flex items-center justify-between rounded-xl bg-slate-900/40 p-3 border border-white/5">
                  <div>
                    ...
                    <p className="text-[10px] text-[#5A554E] mt-0.5 line-clamp-1">{org.description}</p>
                  </div>
                  {org.verified && (
              ...
              userCreatedEvents.map((event) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-[11px] text-[#5A554E] mt-1 line-clamp-1">{event.location}</p>
                  </div>

                  <div className="flex items-center gap-3 text-xs text-[#5A554E] shrink-0">
            ...
            {userCreatedPromos.length === 0 ? (
              ...
              userCreatedPromos.map((promo) => (
                ...
                >
                  ...
                  <p className="text-[11px] text-[#5A554E] mt-1">{promo.description}</p>
                  
                  {promo.feedback && (
                    <div className="mt-2.5 p-2 rounded bg-slate-950/60 border border-white/5 text-[10px] text-[#5A554E] font-mono">
