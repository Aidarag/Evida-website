...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    'bg-gradient-to-r from-[#80B0EC] to-[#ff5d00] text-[#08080B] font-semibold shadow-[0_4px_16px_rgba(128,176,236,0.25)]',
  secondary:
    'bg-gradient-to-r from-[#EE3D5A] to-[#80B0EC] text-white font-semibold shadow-[0_4px_16px_rgba(238,61,90,0.2)]',
  neon:
    'bg-[#ff5d00] text-[#08080B] font-semibold shadow-[0_4px_16px_rgba(218,251,113,0.3)]',
  ghost:
