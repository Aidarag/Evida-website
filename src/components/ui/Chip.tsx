  ...
  return (
    <button
      ...
      className={`
        ...
        ${active
          ? 'bg-[#2A2621] text-white border border-transparent font-bold shadow-sm'
          : 'bg-black/[0.04] text-[#5A554E] border border-transparent hover:bg-black/[0.08] hover:text-[#2A2621]'
        }
        ${className}
      `}
    >
