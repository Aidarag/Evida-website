  ...
  const renderEventCard = (event: Event) => {
    return (
      ...
      >
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            ...
            <p className="text-[10px] text-slate-500 mt-0.5">
              Submitted by <span className="font-semibold text-[#5A554E]">{event.organizer}</span>
        ...
        <p className="text-xs text-[#5A554E] bg-slate-950/40 p-3 rounded-lg border border-white/5 line-clamp-3">
          {event.description}
        </p>

        {/* Date, Time, Location & Stats */}
        <div className="grid gap-3 sm:grid-cols-3 text-[11px] text-[#5A554E] pt-1">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-white/5 bg-slate-900/20 p-5 sm:p-6 relative overflow-hidden">
        ...
        <p className="mt-1 text-xs text-[#5A554E] max-w-xl leading-relaxed">
            ...
            <button
              ...
              className={`flex items-center justify-between rounded-xl border p-3 text-left transition-all hover:scale-[1.01] cursor-pointer ${
                isActive
                  ...
                  : 'bg-transparent text-[#5A554E] border-white/5 hover:text-slate-200 hover:bg-slate-900/10'
              }`}
            >
              <div>
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div>
                    ...
                    <p className="text-[10px] text-slate-500 mt-0.5">
                      Submitted by <span className="font-semibold text-[#5A554E]">{promo.organizer}</span> (Contact: {promo.contactInfo})
                    </p>
                  </div>
