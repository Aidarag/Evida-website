...
export default function AnalyticsView({ analytics }: AnalyticsViewProps) {
  if (!analytics) {
    return (
      <div className="flex h-64 items-center justify-center rounded-2xl border border-white/5 bg-slate-900/10 text-[#5A554E]">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="md:col-span-2 rounded-2xl glass-card p-6 border border-white/5 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-bold text-[#5A554E] uppercase tracking-wider flex items-center gap-1.5">
        ...
        <div className="md:col-span-1 rounded-2xl glass-card p-6 border border-white/5 space-y-5">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 pt-3 border-t border-white/5">
              ...
              <div className="flex items-center gap-3 text-[10px] text-[#5A554E] font-semibold pt-1">
